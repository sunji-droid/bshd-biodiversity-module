...
/* ==========================================================================
   Global Navigation Dropdown (Header Menu)
   ========================================================================== */
function initGlobalNav() {
  ...
  // Nested accordions inside the dropdown: each Unit's subsections, and Settings
  menu.querySelectorAll(".gnav-parent").forEach(parent => {
    const toggleBtn = parent.querySelector(".gnav-parent-toggle");
    if (!toggleBtn) return;
